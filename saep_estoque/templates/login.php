...
<body>
    <div class="login-container">
        <div class="login-box">
            <h2>📦 SAEP</h2>
            <p class="text-center text-muted" style="margin-bottom: 2rem;">Controle de Estoque</p>
            ...
            <div class="text-center" style="border-top: 1px solid #eee; padding-top: 1.5rem;">
                ...
                <a href="app.php?action=cadastro" class="btn btn-secondary" style="width: 100%; margin-top: 0.75rem;">Criar Conta</a>
            </div>
            ...
            <div style="margin-top: 2rem; padding: 1rem; background: #f9f9f9; border-radius: 4px; text-align: center;">
                ...
                <p style="font-size: 0.85rem; color: #666; margin: 0.5rem 0 0 0;"><strong>User:</strong> admin | <strong>Pass:</strong> 123456</p>
            </div>
        </div>
    </div>
</body>
